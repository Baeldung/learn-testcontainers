...
public class CampaignController {
    ...
    @GetMapping
    public Collection<CampaignDto> findAll() {
        Iterable<Campaign> allCampaigns = this.campaignService.findAll();
    ...
    @GetMapping("/by-name")
    public Collection<CampaignDto> findCampaigns(@RequestParam(name = "name", defaultValue = "") String name) {
        Iterable<Campaign> allCampaigns = this.campaignService.findByName(name);
        List<CampaignDto> campaignDtos = new ArrayList<>();
        allCampaigns.forEach(p -> campaignDtos.add(convertToDto(p)));
        return campaignDtos;
    }
